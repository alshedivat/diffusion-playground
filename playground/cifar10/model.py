"""Denoising diffusion model for CIFAR10.
...
class DhariwalUNet(torch.nn.Module):
    """Reimplementation of the ADM architecture from Dhariwal and Nichol (2021).
    Equivalent to the original implementation at https://github.com/openai/guided-diffusion.
